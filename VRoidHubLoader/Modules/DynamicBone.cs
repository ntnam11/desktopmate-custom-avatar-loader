...
public class Particle : UnityEngine.Object
{
    public Particle(IntPtr ptr) : base(ptr) { }
    public Particle() : base(ClassInjector.DerivedConstructorPointer<Particle>())
    {
...
public class ParticleTree : UnityEngine.Object
{
    public ParticleTree(IntPtr ptr) : base(ptr) { }
    public ParticleTree() : base(ClassInjector.DerivedConstructorPointer<ParticleTree>())
    {
        ClassInjector.DerivedConstructorBody(this);
    }
